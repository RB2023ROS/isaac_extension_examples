...
from omni.isaac.examples.isaac_extension_examples.example6_custom_robot import HelloWorld
...
class HelloWorldExtension(BaseSampleExtension):
    def on_startup(self, ext_id: str):
        ...
        super().start_extension(
            ...
            submenu_name="",
            name="Example 6 - Custom Robot Load",
            title="Example 6 - Custom Robot Load",

...
from omni.isaac.examples.isaac_extension_examples.example6_custom_robot.a1_robot_control_sensored import A1RobotControl
...
class A1QPController:
    ...
    def ctrl_state_reset(self) -> None:
        ...
        print("reset ctrl params")
        # TODO: Optimize Gain params
        self._ctrl_params._kp_linear = np.array([800, 800.0, 1900.0])
        self._ctrl_params._kd_linear = np.array([2000.0, 2000.0, 4000.0])
        self._ctrl_params._kp_angular = np.array([1600.0, 1600.0, 0.0])
        self._ctrl_params._kd_angular = np.array([0.0, 0.0, 500.0])
        ...
        self._ctrl_params._robot_mass = 13.2
        # self._ctrl_params._robot_mass = 25.0
